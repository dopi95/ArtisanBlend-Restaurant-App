  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100" id="chatbot">
      ...
      <div className="relative z-10 w-full max-w-4xl border border-gray-300 dark:border-gray-700 rounded-2xl p-6 bg-white dark:bg-gray-800 shadow-lg min-h-[600px] flex flex-col justify-between">
        ...
        {/* Header Text */}
        <div>
          <h2 className="text-center text-2xl font-semibold">How can we assist you today?</h2>
        ...
        <div className="bg-[#f9f7e9] dark:bg-gray-700 rounded-xl overflow-y-auto p-4 space-y-2 text-sm text-gray-800 dark:text-gray-100 flex-1 mb-4">
          ...
          {loading && <div className="italic text-gray-400 dark:text-gray-300">Bot is typing...</div>}
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-around text-xs text-center mt-6 text-black dark:text-white gap-4">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-300">Mon-Sat: 8:00 am to 10:00 pm</p>
          </div>
          <div>
            <p className="font-semibold">Food Offered</p>
            <p className="text-gray-500 dark:text-gray-300">Dine-in, take-away, delivery</p>
          </div>
          <div>
            <p className="font-semibold">Make Reservation</p>
            <p className="text-gray-500 dark:text-gray-300">Online or walk-in reservations</p>
          </div>
        </div>

        {/* Prompt Suggestions */}
        <div className="mt-4 text-sm text-gray-500 dark:text-gray-300">Suggestions:</div>
